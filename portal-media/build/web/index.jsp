<%-- 
    Document   : index
    Created on : 26-Jun-2019, 10:22:15
    Author     : mandr
--%>
...
<html>
    ...
    <body>
        ...
        <p>You are in the index page!</p>
        <jsp:include page="layout/footer.jsp"></jsp:include>
        <jsp:include page="layout/scrips.jsp"></jsp:include>
                        ...
                        <div class="col-md-6">
                                <div class="card">
                                        ...
                                        <div class="card-body text-center">
                                            ...
                                            <a href="detail.jsp" class="btn btn-sm btn-primary">Selengkapnya</a>
                                        </div>
                                    </div>
                        </div>
                        <div class="col-md-6">
